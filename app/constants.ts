export const ALL_OPENAI_MODELS = [
  "babbage-002",
  "chat-latest",
...
export const EVENT_TIMESPANS = [
  { id: "all_available", label: "all available" },
  { id: "past_1_month", label: "1 month old" },
  { id: "past_3_months", label: "3 month old" },

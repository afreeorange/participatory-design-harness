...
function ModelIcon({
  ...
  return (
    <span
      className={cn(
        "flex justify-center items-center size-3.5 [&_svg]:size-3.5 shrink-0",
        className,
      )}
    >
      {children}
...
function ModelSelectorItem({
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <span className="top-2.5 absolute flex justify-center items-center size-4 end-3">
      ...
      >
        {efforts.map((option) => (
          <Radio.Root
            ...
            value={option.id}
            className={cn(
              "px-2 py-1 rounded-md outline-none focus-visible:ring-2 focus-visible:ring-ring/50 text-muted-foreground hover:text-foreground text-xs transition-colors",

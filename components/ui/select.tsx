  ...
  <SelectPrimitive.Portal>
    ...
    >
      <SelectPrimitive.Popup
        ...
        className={cn(
          "z-50 relative bg-popover/95 shadow-lg backdrop-blur-sm p-1.5 border rounded-xl min-w-[max(8rem,var(--anchor-width))] max-h-[min(24rem,var(--available-height))] overflow-x-hidden overflow-y-auto text-popover-foreground",
...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      "relative flex items-center gap-2 py-2 ps-3 pe-9 rounded-lg outline-none w-full text-sm cursor-default select-none",
...
function Select({
  ...
  return (
    ...
    >
      <SelectPrimitive.Trigger
        className={cn(
          "flex items-center gap-1.5 py-1 ps-3 pe-2 rounded-md outline-none text-sm transition-colors",
      ...
      >
        ...
        <ChevronDownIcon className="opacity-50 size-3.5" />
      </SelectPrimitive.Trigger>
